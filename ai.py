...
class AICommandGenerator:
    ...
    def __init__(self, registry: CapabilityRegistry, api_key: Optional[str] = None):
        ...
        Args:
            ...
            api_key: Optional API key for LLM service (defaults to OpenAI if available)
        """
    ...
    def _setup_llm(self):
        """Set up the LLM client (OpenAI by default, can be extended for other providers)."""
        try:
            import openai
            ...
            print("Warning: OpenAI library not installed. AI features will be limited.")
    ...
    def generate_command_from_natural_language(self, instruction: str, user_id: str) -> Dict:
        ...
        if self.use_openai and self.client:
            return self._generate_with_openai(instruction, capability_context, user_id)
        else:
    ...
    def _generate_with_openai(self, instruction: str, capability_context: str, user_id: str) -> Dict:
